...
const inputSchema = z.object({
  ...
  path: z.object({
    goodsReceiptId: z.string().describe('The unique id of the goods receipt'),
  }),
  query: z.object({
    environmentName: z
      .string()
...
export const apiTool = {
  name: 'getGoodsReceipt',
  description: 'Get a goods receipt by id',
  input: inputSchema,
