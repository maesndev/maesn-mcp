...
const lineItemSchema = z.object({
  ...
  description: z
    .string()
    .describe('Description of the credited product or service')
    .optional(),
  dimensions: z
  ...
  itemId: z
    .string()
    .describe('Unique identifier of the credited item')
    .optional(),
  itemName: z
    .string()
    .describe('Short name or label of the credited item')
    .optional(),
  quantity: z
    .number()
    .describe('Quantity of units credited for this line item')
    .optional(),
...
const inputSchema = z.object({
  ...
  path: z.object({
    vendorCreditId: z
      .string()
      .describe('The unique id of the vendor credit you want to update'),
  }),
  query: z
    .object({
      environmentName: z
  ...
  body: z
    .object({
      accountId: z
        .string()
        .describe(
          'Identifier of the main account associated with the vendor credit'
        )
        .optional(),
      addresses: z
        .array(addressSchema)
        .default([])
        .describe('List of addresses associated with the vendor credit')
        .optional(),
      contactId: z
        .string()
        .describe(
          'Identifier of the contact or supplier linked to the vendor credit'
        )
        .optional(),
      currency: z
        .string()
        .describe('Currency code (ISO 4217) of the vendor credit')
        .optional(),
      deliveryDate: z
        .string()
      ...
      dueDate: z
        .string()
        .describe('Date when the vendor credit is due for settlement')
        .optional(),
      journalCode: z
        .string()
        .describe('Journal code where the vendor credit is recorded')
        .optional(),
      lineItems: z
        .array(lineItemSchema)
        .default([])
        .describe('Detailed list of credited products or services')
        .optional(),
      name: z
        .string()
        .describe('Title or label of the vendor credit, often a supplier name')
        .optional(),
      oneLineAddress: z
        .string()
      ...
      paidDate: z
        .string()
        .describe('Date when the vendor credit was paid, in ISO 8601 format')
        .optional(),
      paymentDays: z
        .number()
        .describe('Number of days allowed for settlement')
        .optional(),
      paymentStatus: z
        .enum([
          'NO_OPEN_ITEM',
      ...
      paymentTermId: z
        .string()
        .describe('Identifier of the payment term applied to the vendor credit')
        .optional(),
      reference: z
        .string()
        .describe(
          'Reference number or external identifier for the vendor credit'
        )
        .optional(),
      shippingDate: z
        .string()
      ...
      status: z
        ...
        .describe('Current status of the vendor credit')
        .optional(),
      taxRule: z
        .enum([
          'NET',
        ...
        .describe('Tax calculation rule applied')
        .optional(),
      taxText: z
        .string()
      ...
      totalDiscountAmount: z
        .number()
        .describe('Total discount amount applied to the vendor credit')
        .optional(),
      totalDiscountPercentage: z
        .number()
        .describe('Overall discount percentage applied to the vendor credit')
        .optional(),
      totalGrossAmount: z
        .number()
        .describe('Total gross amount including tax for the vendor credit')
        .optional(),
      totalNetAmount: z
        .number()
        .describe('Total net amount excluding tax for the vendor credit')
        .optional(),
      totalTaxAmount: z
        .number()
        .describe('Total tax amount applied to the vendor credit')
        .optional(),
      vendorCreditDate: z
        .string()
        .describe('Date when the vendor credit was created')
        .optional(),
      vendorCreditNumber: z
        .string()
        .describe('Unique number or identifier assigned to the vendor credit')
        .optional(),
    })
    .describe('The data of the vendorCredit you want to create ')
    .default({}),
});

export const apiTool = {
  name: 'putVendorCredit',
  description:
    'Update a vendor credit with the PUT command. This means you replace the whole vendor credit object with a new one',
  input: inputSchema,
